 ...
 */
final class Version20201107172733 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__brew AS SELECT id, name, abv, ibu, ebc, state, produced_quantity, started, ended, created FROM brew');
        $this->addSql('DROP TABLE brew');
        $this->addSql('CREATE TABLE brew (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL COLLATE BINARY, abv INTEGER NOT NULL, ibu INTEGER NOT NULL, ebc INTEGER NOT NULL, state VARCHAR(255) NOT NULL COLLATE BINARY, started DATETIME DEFAULT NULL, ended DATETIME DEFAULT NULL, created DATETIME NOT NULL, produced_quantity INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO brew (id, name, abv, ibu, ebc, state, produced_quantity, started, ended, created) SELECT id, name, abv, ibu, ebc, state, produced_quantity, started, ended, created FROM __temp__brew');
        $this->addSql('DROP TABLE __temp__brew');
    }
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__brew AS SELECT id, name, abv, ibu, ebc, state, produced_quantity, started, ended, created FROM brew');
        $this->addSql('DROP TABLE brew');
        $this->addSql('CREATE TABLE brew (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, name VARCHAR(255) NOT NULL, abv INTEGER NOT NULL, ibu INTEGER NOT NULL, ebc INTEGER NOT NULL, state VARCHAR(255) NOT NULL, started DATETIME DEFAULT NULL, ended DATETIME DEFAULT NULL, created DATETIME NOT NULL, produced_quantity INTEGER NOT NULL)');
        $this->addSql('INSERT INTO brew (id, name, abv, ibu, ebc, state, produced_quantity, started, ended, created) SELECT id, name, abv, ibu, ebc, state, produced_quantity, started, ended, created FROM __temp__brew');
        $this->addSql('DROP TABLE __temp__brew');
        $this->addSql('DROP INDEX UNIQ_6BAF78705E237E06');
        $this->addSql('DROP INDEX IDX_6BAF7870DCF9352B');
