 ...
 */
final class Version20210314175106 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_520431A18D9F6D38');
        $this->addSql('CREATE TEMPORARY TABLE __temp__ingredient_stock AS SELECT id, ingredient_id, supplier_id, order_id, creation_date, quantity, price, state, ordered_date, received_date, ended_date, delivery_scheduled_for FROM ingredient_stock');
        $this->addSql('DROP TABLE ingredient_stock');
        $this->addSql('CREATE TABLE ingredient_stock (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, ingredient_id INTEGER NOT NULL, supplier_id INTEGER DEFAULT NULL, order_id INTEGER DEFAULT NULL, creation_date DATE NOT NULL, quantity INTEGER DEFAULT NULL, price INTEGER DEFAULT NULL, state VARCHAR(10) NOT NULL COLLATE BINARY, ordered_date DATE DEFAULT NULL, received_date DATE DEFAULT NULL, ended_date DATE DEFAULT NULL, delivery_scheduled_for DATE DEFAULT NULL, CONSTRAINT FK_520431A1933FE08C FOREIGN KEY (ingredient_id) REFERENCES ingredient (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_520431A18D9F6D38 FOREIGN KEY (order_id) REFERENCES "order" (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_520431A12ADD6D8C FOREIGN KEY (supplier_id) REFERENCES supplier (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO ingredient_stock (id, ingredient_id, supplier_id, order_id, creation_date, quantity, price, state, ordered_date, received_date, ended_date, delivery_scheduled_for) SELECT id, ingredient_id, supplier_id, order_id, creation_date, quantity, price, state, ordered_date, received_date, ended_date, delivery_scheduled_for FROM __temp__ingredient_stock');
        ...
        $this->addSql('CREATE INDEX IDX_520431A18D9F6D38 ON ingredient_stock (order_id)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_520431A18D9F6D38');
        $this->addSql('DROP INDEX IDX_520431A12ADD6D8C');
        $this->addSql('CREATE TEMPORARY TABLE __temp__ingredient_stock AS SELECT id, ingredient_id, order_id, supplier_id, creation_date, quantity, price, state, ordered_date, received_date, ended_date, delivery_scheduled_for FROM ingredient_stock');
        $this->addSql('DROP TABLE ingredient_stock');
        $this->addSql('CREATE TABLE ingredient_stock (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, ingredient_id INTEGER NOT NULL, order_id INTEGER DEFAULT NULL, supplier_id INTEGER DEFAULT NULL, creation_date DATE NOT NULL, quantity INTEGER DEFAULT NULL, price INTEGER DEFAULT NULL, state VARCHAR(10) NOT NULL, ordered_date DATE DEFAULT NULL, received_date DATE DEFAULT NULL, ended_date DATE DEFAULT NULL, delivery_scheduled_for DATE DEFAULT NULL)');
        $this->addSql('INSERT INTO ingredient_stock (id, ingredient_id, order_id, supplier_id, creation_date, quantity, price, state, ordered_date, received_date, ended_date, delivery_scheduled_for) SELECT id, ingredient_id, order_id, supplier_id, creation_date, quantity, price, state, ordered_date, received_date, ended_date, delivery_scheduled_for FROM __temp__ingredient_stock');
        $this->addSql('DROP TABLE __temp__ingredient_stock');
        $this->addSql('CREATE INDEX IDX_520431A1933FE08C ON ingredient_stock (ingredient_id)');
        $this->addSql('CREATE INDEX IDX_520431A18D9F6D38 ON ingredient_stock (order_id)');
        $this->addSql('CREATE INDEX IDX_520431A12ADD6D8C ON ingredient_stock (supplier_id)');
