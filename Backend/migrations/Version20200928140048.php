 ...
 */
final class Version20200928140048 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE bottle (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, volume INTEGER NOT NULL, type VARCHAR(30) NOT NULL, color VARCHAR(30) NOT NULL)');
