 ...
 */
final class Version20201114144118 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE stock_not_order (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, stock_id INTEGER NOT NULL, ordered_id INTEGER NOT NULL, quantity INTEGER NOT NULL)');
