 ...
 */
final class Version20201109125818 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_1607B8AFDCD6110');
        $this->addSql('DROP INDEX IDX_1607B8AFF9955242');
        $this->addSql('CREATE TEMPORARY TABLE __temp__brew_ingredient AS SELECT id, brew_id, stock_id, quantity FROM brew_ingredient');
        ...
        $this->addSql('INSERT INTO brew_ingredient (id, brew_id, ingredient_id, quantity) SELECT id, brew_id, stock_id, quantity FROM __temp__brew_ingredient');
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__ingredient_stock AS SELECT id, ingredient_id, creation_date, state, ordered_date, received_date, ended_date, quantity, price FROM ingredient_stock');
        ...
        $this->addSql('INSERT INTO ingredient_stock (id, ingredient_id, creation_date, state, ordered_date, received_date, ended_date, quantity, price) SELECT id, ingredient_id, creation_date, state, ordered_date, received_date, ended_date, quantity, price FROM __temp__ingredient_stock');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE brew_ingredient');
        $this->addSql('CREATE TABLE brew_ingredient (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, brew_id INTEGER NOT NULL, quantity INTEGER NOT NULL, stock_id INTEGER NOT NULL)');
        $this->addSql('INSERT INTO brew_ingredient (id, brew_id, stock_id, quantity) SELECT id, brew_id, ingredient_id, quantity FROM __temp__brew_ingredient');
        $this->addSql('DROP TABLE __temp__brew_ingredient');
        $this->addSql('CREATE INDEX IDX_1607B8AFF9955242 ON brew_ingredient (brew_id)');
        ...
        $this->addSql('DROP TABLE ingredient_stock');
        $this->addSql('CREATE TABLE ingredient_stock (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, ingredient_id INTEGER NOT NULL, creation_date DATE NOT NULL, quantity INTEGER DEFAULT NULL, price INTEGER DEFAULT NULL, state VARCHAR(10) NOT NULL, ordered_date DATE DEFAULT NULL, received_date DATE DEFAULT NULL, ended_date DATE DEFAULT NULL)');
