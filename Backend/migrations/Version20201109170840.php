 ...
 */
final class Version20201109170840 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__brew_stock AS SELECT id, brew_id, stock_id, quantity FROM brew_stock');
        ...
        $this->addSql('INSERT INTO brew_stock (id, brew_id, stock_id, quantity) SELECT id, brew_id, stock_id, quantity FROM __temp__brew_stock');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__brew_stock AS SELECT id, brew_id, stock_id, quantity FROM brew_stock');
        $this->addSql('DROP TABLE brew_stock');
        $this->addSql('CREATE TABLE brew_stock (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, brew_id INTEGER NOT NULL, stock_id INTEGER NOT NULL, quantity INTEGER NOT NULL)');
        $this->addSql('INSERT INTO brew_stock (id, brew_id, stock_id, quantity) SELECT id, brew_id, stock_id, quantity FROM __temp__brew_stock');
        $this->addSql('DROP TABLE __temp__brew_stock');
        $this->addSql('CREATE INDEX IDX_29C50C4DF9955242 ON brew_stock (brew_id)');
        $this->addSql('CREATE INDEX IDX_29C50C4DDCD6110 ON brew_stock (stock_id)');
