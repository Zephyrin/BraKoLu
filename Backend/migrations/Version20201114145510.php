 ...
 */
final class Version20201114145510 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('DROP INDEX IDX_350A30F8AA60395A');
        $this->addSql('DROP INDEX IDX_350A30F8DCD6110');
        $this->addSql('CREATE TEMPORARY TABLE __temp__stock_not_order AS SELECT id, ordered_id FROM stock_not_order');
        $this->addSql('DROP TABLE stock_not_order');
        $this->addSql('CREATE TABLE stock_not_order (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, ordered_id INTEGER NOT NULL, brew_stock_id INTEGER NOT NULL, CONSTRAINT FK_350A30F8AA60395A FOREIGN KEY (ordered_id) REFERENCES "order" (id) NOT DEFERRABLE INITIALLY IMMEDIATE, CONSTRAINT FK_350A30F859B8A2B9 FOREIGN KEY (brew_stock_id) REFERENCES brew_stock (id) NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO stock_not_order (id, ordered_id) SELECT id, ordered_id FROM __temp__stock_not_order');
        $this->addSql('DROP TABLE __temp__stock_not_order');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE INDEX IDX_BA5B61BD2ADD6D8C ON ingredient_stock_supplier (supplier_id)');
        $this->addSql('DROP INDEX IDX_350A30F8AA60395A');
        $this->addSql('DROP INDEX UNIQ_350A30F859B8A2B9');
        $this->addSql('CREATE TEMPORARY TABLE __temp__stock_not_order AS SELECT id, ordered_id, brew_stock_id FROM stock_not_order');
        $this->addSql('DROP TABLE stock_not_order');
        $this->addSql('CREATE TABLE stock_not_order (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, ordered_id INTEGER NOT NULL, stock_id INTEGER NOT NULL, quantity INTEGER NOT NULL)');
        $this->addSql('INSERT INTO stock_not_order (id, ordered_id, stock_id) SELECT id, ordered_id, brew_stock_id FROM __temp__stock_not_order');
        $this->addSql('DROP TABLE __temp__stock_not_order');
        $this->addSql('CREATE INDEX IDX_350A30F8AA60395A ON stock_not_order (ordered_id)');
        $this->addSql('CREATE INDEX IDX_350A30F8DCD6110 ON stock_not_order (stock_id)');
    }
}
