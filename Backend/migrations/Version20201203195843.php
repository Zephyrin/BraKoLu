 ...
 */
final class Version20201203195843 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('INSERT INTO ingredient_stock (id, ingredient_id, order_id, supplier_id, creation_date, quantity, price, state, ordered_date, received_date, ended_date) SELECT id, ingredient_id, ordered_id, supplier_id, creation_date, quantity, price, state, ordered_date, received_date, ended_date FROM __temp__ingredient_stock');
    ...
    public function down(Schema $schema) : void
    {
        ...
        $this->addSql('DROP TABLE ingredient_stock');
        $this->addSql('CREATE TABLE ingredient_stock (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, ingredient_id INTEGER NOT NULL, supplier_id INTEGER DEFAULT NULL, creation_date DATE NOT NULL, quantity INTEGER DEFAULT NULL, price INTEGER DEFAULT NULL, state VARCHAR(10) NOT NULL, ordered_date DATE DEFAULT NULL, received_date DATE DEFAULT NULL, ended_date DATE DEFAULT NULL, ordered_id INTEGER DEFAULT NULL)');
        $this->addSql('INSERT INTO ingredient_stock (id, ingredient_id, ordered_id, supplier_id, creation_date, quantity, price, state, ordered_date, received_date, ended_date) SELECT id, ingredient_id, order_id, supplier_id, creation_date, quantity, price, state, ordered_date, received_date, ended_date FROM __temp__ingredient_stock');
        $this->addSql('DROP TABLE __temp__ingredient_stock');
        $this->addSql('CREATE INDEX IDX_520431A1933FE08C ON ingredient_stock (ingredient_id)');
        $this->addSql('CREATE INDEX IDX_520431A12ADD6D8C ON ingredient_stock (supplier_id)');
