 ...
 */
final class Version20201114234200 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('INSERT INTO stock_not_order (id, ordered_id, brew_stock_id) SELECT id, ordered_id, brew_stock_id FROM __temp__stock_not_order');
